...
:::message alert
**2026年9月1日現在**、Koyebは**2026年2月17日にMistral AIに買収**されています（[公式発表](https://www.koyeb.com/blog/koyeb-is-joining-mistral-ai-to-build-the-future-of-ai-infrastructure)）。
これに伴い、無料のStarterプランは**新規登録ができなくなりました**（新規登録はProプラン $29/月〜）。
既存のStarterプラン組織は当面使えますが、公式FAQでは「Starterプランは近日中に削除予定」とされており、廃止時期は未公表です。
これから新しく始める方は、代替サービスへの検討をしてください。
:::
